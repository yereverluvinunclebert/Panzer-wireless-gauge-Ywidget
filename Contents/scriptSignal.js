...
/*    
    if (preferences.actionSwitchPref.value === "tick") {
        pointer.rotation = (percentageBandwidth * 3) + 30;
        pointerShadow.rotation = pointer.rotation;
    } else {
        // zero pointer smoothly
        rotateObject(pointer, (percentageBandwidth * 3) + 30);
        rotateObject(pointerShadow, (percentageBandwidth * 3) + 30);
    }
*/
    ...
    */
    ...
    if (preferences.wirelessSwitch.value === "on") {
        ...
        if (systemAirport.available && systemAirport.powered) {
            ...
            wirelessPercentTextArea.data = wirelessText;
            ...
            networkScaleTextArea.data = percentageBandwidth;
            ...
            wirelessPercentTextArea.data = "000";
